...
export default function RegisterPage() {
  ...
  return (
    <div className="min-h-screen flex flex-col" style={{ background: "#f5f5f5", fontFamily: "'DM Sans', 'Inter', sans-serif" }}>
      <style>{`
        @import url('https://fonts.googleapis.com/css2?family=DM+Sans:wght@400;500;600;700;800&display=swap');
        @keyframes fadeUp { from { opacity: 0; transform: translateY(18px); } to { opacity: 1; transform: translateY(0); } }
        @keyframes floatA { 0%, 100% { transform: translateY(0); } 50% { transform: translateY(-12px) rotate(4deg); } }
        @keyframes floatB { 0%, 100% { transform: translateY(0); } 50% { transform: translateY(-8px) rotate(-3deg); } }
        @keyframes bobCard { 0%, 100% { transform: translateY(0) rotate(-1deg); } 50% { transform: translateY(-10px) rotate(1deg); } }
      ...
      <main className="flex-1 flex items-center justify-center px-6 py-4">
        <div
          className="w-full flex items-center justify-center gap-8 lg:gap-12"
          style={{ maxWidth: "1100px", margin: "0 auto" }}
        >
          {/* LEFT — Illustration */}
          <div className="hidden lg:flex flex-col items-center flex-1 relative fade-up2">
            <div className="relative" style={{ zIndex: 1, width: "460px", height: "430px" }}>
              <svg width="460" height="430" viewBox="0 0 560 520" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M100 90 C35 125 -10 245 35 365 C80 485 235 568 385 550 C535 532 628 418 612 278 C596 138 492 22 348 6 C204 -10 165 55 100 90Z" fill="#E0F2F1" fillOpacity="0.75"/>
                ...
                <rect x="190" y="158" width="180" height="68" rx="10" fill="url(#bannerGrad)"/>
                ...
                <defs>
                  <linearGradient id="bannerGrad" x1="190" y1="158" x2="370" y2="226" gradientUnits="userSpaceOnUse">
                ...
                <g className="float-b" style={{ transformOrigin: "432px 290px" }}>
                  ...
                  {[18, 30, 22, 38, 26, 44, 34].map((h, i) => (
                    <rect key={i} x={406 + i * 16} y={320 - h} width="10" height={h} rx="4" fill={i === 5 ? "#1A3C34" : "#D1FAE5"}/>
                  ))}
                </g>
          ...
          {/* RIGHT — Form Card */}
          <div className="w-full lg:flex-shrink-0 fade-up" style={{ maxWidth: "420px" }}>
            <div className="bg-white rounded-3xl px-8 py-8" style={{ boxShadow: "0 4px 28px rgba(0,0,0,0.09)", border: "1px solid #E8E8E8" }}>
              ...
              <div style={{ marginBottom: "16px" }}>
                ...
                <p style={{ fontFamily: "inherit", fontSize: "14px", color: "#888", margin: 0 }}>
                  Sudah punya akun?{" "}
                  <Link href="/login" style={{ fontWeight: 700, color: "#1A3C34", textDecoration: "none" }}>Masuk di sini</Link>
                </p>
              </div>
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <div>
                  ...
                  <input
                    ...
                    style={{ fontFamily: "inherit", fontSize: "15px", height: "44px" }}
                ...
                {/* Email */}
                <div>
                  <label style={{ display: "block", fontSize: "13px", fontWeight: 700, color: "#0A0A0A", marginBottom: "7px", fontFamily: "inherit" }}>Email</label>
                  <input
                ...
                {/* Password */}
                <div>
                  <label style={{ display: "block", fontSize: "13px", fontWeight: 700, color: "#0A0A0A", marginBottom: "7px", fontFamily: "inherit" }}>Password</label>
                  <div className="relative">
                    ...
                    />
                    <button type="button" onClick={() => setShowPassword(!showPassword)} className="absolute right-4 top-1/2 -translate-y-1/2 text-[#BDBDBD] hover:text-[#777] transition-colors">
                      {showPassword ? (
                ...
                <button
                  ...
                  style={{ fontFamily: "inherit", fontSize: "15px", fontWeight: 700, height: "50px", marginTop: "2px" }}
              ...
              <div className="flex items-center gap-3" style={{ margin: "14px 0" }}>
                ...
                <span style={{ fontSize: "12px", color: "#C0BDB6", fontWeight: 500, fontFamily: "inherit" }}>atau</span>
                <div className="flex-1 h-px bg-[#EBEBEB]" />
              </div>
              ...
              <button
                ...
                style={{ height: "44px", fontSize: "14px", fontWeight: 600, color: "#1A1A1A", fontFamily: "inherit", boxShadow: "0 1px 4px rgba(0,0,0,0.07)" }}
              >
              ...
              <p style={{ marginTop: "14px", textAlign: "center", fontSize: "11px", color: "#BBBBBB", lineHeight: 1.7, fontFamily: "inherit" }}>
